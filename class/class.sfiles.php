<?php
// $Id: class.sfiles.php,v 1.8 2004/08/03 16:48:57 hthouzard Exp $
//  ------------------------------------------------------------------------ //
...
include_once XOOPS_ROOT_PATH . "/modules/recette/class/class.mimetype.php";
...
class sFiles {
    ...
    function sFiles($fileid=-1)
    {
        ...
        $this->table = $this->db->prefix("recette_files");
        $this->storyid = 0;
        $this->filerealname = "";
        $this->date = 0;
        $this->mimetype = "";
    ...
    function store()
    {
       ...
       if(!isset($this->fileid)) {
            ...
            $sql = "UPDATE ".$this->table." SET storyid=".$storyid.",filerealname='".$this->filerealname."',date=".$date.",mimetype='".$mimetype."',downloadname='".$downloadname."',counter=".$counter." WHERE fileid=".$this->getFileid();
       }
